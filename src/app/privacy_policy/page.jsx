  ...
  return (
    <div className="min-h-screen text-gray-900 dark:text-gray-100 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <h2 className="text-2xl font-semibold mb-4">Transparency and Choice</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mb-4">Information You Share</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mb-4">Accessing and Updating Your Personal Information</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mb-4">Compliance and Cooperation with Regulatory Authorities</h2>
        <p className="mb-4">
